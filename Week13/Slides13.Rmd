...
* We have already seen several examples:
    ...
    * Bowling: $x_2$ depends on $n = 10 - x_1$ and both depend on inability, $\Upsilon$
    ...
    * Police stops HW: Probability of arrest depends on search which depends on department and race parameters,
        which depend on North Carolina parameters
...
post <-  stan_glmer(valence ~ arousal + (1 + arousal | PID), data = dat,
                    ...
                    prior_aux = rstanarm::exponential(rate = 0.1))
```
<div class="columns-2">
